...
public class Kiosque extends Activity implements ApiCaller {
    ...
    private final String TAG = "Kiosque";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            setHeader();
            _videosLinearLayout = (LinearLayout)findViewById(R.id.linearLayout_videos_com_videonews_kiosque);
            callApiForNews();
        }
        TextView loadMoreTV = (TextView)findViewById(R.id.textView_loadmore_com_videonews_kiosque);
    ...
    private void setHeader() {
        ...
        setContentView(R.layout.com_videonews_kiosque);
        setLayoutTheme();
    ...
    public void addNewVideo(String imgUrl, String text, final String id) {
        ...
        imageVideoLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent videoNewsIntent = new Intent(Kiosque.this, VideoNews.class);
    ...
    public void onMessageButtonClicked(View view) {
        Intent messagesIntent = new Intent(Kiosque.this, DisplayMessages.class);
